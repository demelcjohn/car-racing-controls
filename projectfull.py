...
with mp_hands.Hands(
  ...
  while cap.isOpened():
    ...
    if len(co) == 2:
        ...
        if co[0][0] > co[1][0] and co[0][1]>co[1][1] and co[0][1] - co[1][1] > 70:
            print("Turn left.")
        ...
        elif co[1][0] > co[0][0] and co[1][1]> co[0][1]+100 and co[1][1] - co[0][1] > 70:
            print("Turn left.")
            keyinput.release_key('s')
            keyinput.release_key('d')
            keyinput.press_key('a')
        ...
        elif co[0][0] > co[1][0] and co[1][1]> co[0][1] and co[1][1] - co[0][1] > 70:
            print("Turn right.")
            keyinput.release_key('s')
        ...
        elif co[1][0] > co[0][0] and co[0][1]> co[1][1] and co[0][1] - co[1][1] > 70:
            print("Turn right.")
            keyinput.release_key('s')
            keyinput.release_key('a')
            keyinput.press_key('d')
